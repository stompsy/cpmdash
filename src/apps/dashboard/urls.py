...
from .views import (
    ...
    hargrove_grant,
    hargrove_grant_export,
    hargrove_metric_save,
...
urlpatterns = [
    ...
    path(
        "hargrove-grant/export/<int:year>/<int:q>/",
        hargrove_grant_export,
        name="hargrove_grant_export",
    ),
    path("hargrove-grant/metric/save/", hargrove_metric_save, name="hargrove_metric_save"),
